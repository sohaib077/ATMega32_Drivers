...
#define TIMER1_CHANNEL_A_FAST_PWM_COMPARE_OUT_MODE             TIMER1_NON_PWM_COMPARE_OUT_NORMAL_MODE
#define TIMER1_CHANNEL_B_FAST_PWM_COMPARE_OUT_MODE             TIMER1_NON_PWM_COMPARE_OUT_NORMAL_MODE
...
#define TIMER1_CHANNEL_A_CTC_VALUE         192  /* OCR1A value */
#define TIMER1_CHANNEL_B_CTC_VALUE         192  /* OCR1B value */

#define TIMER1_ICR1_VALUE                  192   /* ICR1 value */
